...
class PieBiometricAuth(private val context: Context) : BiometricAuth {
    ...
    private fun internalAuthenticate(
        cryptoObject: BiometricAuth.Crypto?, title: CharSequence,
        subtitle: CharSequence?, description: CharSequence?,
        negativeButtonText: CharSequence
    ): Maybe<BiometricAuth.Crypto> {
        return Flowable
            .create<AuthenticationEvent>({ emitter ->
                ...
                biometricPrompt = BiometricPrompt.Builder(context).apply {
                    setTitle(title)
                    ...
                    setNegativeButton(
                        ...
                        DialogInterface.OnClickListener { _, _ ->
                            ...
                            } catch (i: BiometricAuthenticationCancelledException) {
            ...
            .flatMapMaybe { event ->
                when (event) {
                    ...
                    is AuthenticationEvent.Error -> Maybe.error(
    ...
    override fun authenticate(
        cryptoObject: BiometricAuth.Crypto,
        title: CharSequence,
        subtitle: CharSequence?,
        description: CharSequence?,
        prompt: CharSequence,
        notRecognizedErrorText: CharSequence,
        negativeButtonText: CharSequence
    ): Single<BiometricAuth.Crypto> {
    ...
    override fun authenticate(
        title: CharSequence, subtitle: CharSequence?, description: CharSequence?,
