...
class MarshmallowFingerprintDialog : BottomSheetDialogFragment() {
    ...
    private fun showError(message: CharSequence) {
        ...
        iconTextView.setTextColor(
            ContextCompat.getColor(
                ...
                R.color.biometric_icon_text_color_error
            )
        )
            ...
            .subscribe(
                {
                    ...
                    iconTextView.text =
                        arguments?.getCharSequence(EXTRA_PROMPT) ?: "Touch the fingerprint sensor"
                    iconTextView.setTextColor(
                        ContextCompat.getColor(
                            iconTextView.context,
                            R.color.biometric_icon_text_color
                        )
                    )
    ...
    private fun MaybeEmitter<BiometricAuth.Crypto>.onCancel() =
        this.onError(BiometricAuthenticationCancelledException())
    ...
    internal class FixedWidthInLandscapeBottomSheetDialog(
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            if (context.resources.configuration.orientation==Configuration.ORIENTATION_LANDSCAPE) {
                window?.setLayout(
                    fixedLandscapeWidthInDp.dpAsPixel,
