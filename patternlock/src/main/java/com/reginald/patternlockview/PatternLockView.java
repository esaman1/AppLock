...
public class PatternLockView extends ViewGroup {
    ...
    public void setNodeHighlightSrc(Drawable node) {
        this.mNodeHighlightSrc = node;
        invalidate();
    }

    public void setNodeSrc(Drawable node) {
        this.mNodeSrc = node;
        invalidate();
    }

    public void setNodeErrorSrc(Drawable node) {
        this.mNodeErrorSrc = node;
        invalidate();
    }
    ...
    public void setLineCorrectColor(int color) {
        this.mLineCorrectColor = color;
        invalidate();
    }
